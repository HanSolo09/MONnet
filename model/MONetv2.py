...
from keras.layers import Dense, Conv2D, BatchNormalization, Activation, concatenate, Flatten, Input, add
...
def MONetv2(shape0, shape1, shape2, n_label):
