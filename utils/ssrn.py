...
def basic_block_spc(nb_filter, init_subsample=(1, 1, 1), is_first_block_of_first_layer=False):
    ...
    def f(input):
        ...
        if is_first_block_of_first_layer:
            ...
            #                       kernel_dim1=1, kernel_dim2=1, kernel_dim3=3,
            #                      subsample=init_subsample,
            #                      init="he_normal", border_mode="same",
            #                      W_regularizer=l2(0.0001))(input)
            conv1 = Conv3D(kernel_initializer="he_normal", strides=init_subsample, kernel_regularizer=regularizers.l2(0.0001),
                          filters=nb_filter, kernel_size=(1, 1, 3), padding='same')(input)
        else:
            conv1 = _bn_relu_conv_spc(nb_filter=nb_filter, kernel_dim1=1, kernel_dim2=1, kernel_dim3=3, subsample=init_subsample)(input)

        residual = _bn_relu_conv_spc(nb_filter=nb_filter, kernel_dim1=1, kernel_dim2=1, kernel_dim3=3)(conv1)
...
class ResnetBuilder(object):
    ...
    def build(input_shape, num_outputs, block_fn_spc, block_fn, repetitions1, repetitions2):
        ...
        conv1_spc = _conv_bn_relu_spc(nb_filter=24, kernel_dim1=1, kernel_dim2=1, kernel_dim3=3, subsample=(1, 1, 2))(input)
